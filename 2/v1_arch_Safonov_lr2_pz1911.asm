...
ef_ad222 dw ?;effective address of 222 in numbers
A dd ?;new number1
B dw ?;new number3
C dw ?;new number3v2
...
;body
push word ptr [A+17];"re" to stack
push word ptr [A+15];"mo" to stack
push word ptr [A+22];"an" to stack
push word ptr [A+20];"th" to stack

pop word ptr [A+15];"th" to A+15
pop word ptr [A+17];"an" to A+17
pop word ptr [A+20];"mo" to A+20
pop word ptr [A+22];"re" to A+22 ~end of task1

lea ax, byte ptr [numbers+2];/effective address of 222 in numbers/ to ax
mov ef_ad222, ax;/effective address of 222 in numbers/ to /ef_ad222/ ~end of task2
